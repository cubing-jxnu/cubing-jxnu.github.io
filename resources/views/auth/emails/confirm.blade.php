                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h1 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;">
                                        感谢您在 江西师范大学 Cubing 魔方协会 网站进行注册！
                                    </h1>
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        这是一封激活账号邮件，如果是您本人操作，请点击以下按钮继续：</p>
                                        ...
                                        <tr>
                                            <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                                    如果“激活账号”按钮出现问题，或无法打开链接，请复制下方链接在浏览器中打开: <a
                                                            href="{{ route('confirm.email', $user->activation_token) }}"
                                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;"
                                                            rel="noopener" target="_blank">{{ route('confirm.email', $user->activation_token) }}</a>
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
